...
`core:build-cleanup` | Deletes those css and js files from dist that were generated by the prepare-build:dist task and leaves the dist directory in a clean state without any remaining empty directories.
