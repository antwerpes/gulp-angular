...
`core:serve:dist` | Starts a local web server serving the production-/distribution-ready version of the web app. Runs `core:build`, `core:serve:dist-browser-sync` in sequence.
